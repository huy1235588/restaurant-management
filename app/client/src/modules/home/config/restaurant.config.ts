 ...
 * 
 * Note: This interface matches the RestaurantSettingsApiResponse from API
 * but flattened for easier component usage
 */
...
export interface RestaurantInfo {
    ...
    description: string;
    aboutTitle: string;
    aboutContent: string; // Can contain multiple paragraphs separated by \n\n
    address: string;
    phone: string;
    email: string;
    mapEmbedUrl?: string;
