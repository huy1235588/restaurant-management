...
export function ReservationCard({
    ...
    return (
        <div
            className={`group relative bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all duration-300 overflow-hidden cursor-pointer ${upcoming ? 'ring-2 ring-blue-500 dark:ring-blue-400 ring-opacity-50' : ''
                }`}
            onClick={onClick}
        >
            {/* Accent Bar */}
