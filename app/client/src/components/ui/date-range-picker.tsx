...
// Define default presets (will be overridden by translations)
...
export const DateRangePicker: FC<DateRangePickerProps> & {
    ...
    translations
        ...
        // Merge translations with default presets
        const PRESETS: Preset[] = DEFAULT_PRESETS.map(preset => ({
            name: preset.name,
            label: translations?.[preset.name as keyof typeof translations] || preset.label
        }));
                                    ...
                                    {showCompare && (
                                        <div className="flex items-center space-x-2 pr-4 py-1">
                                            <Switch
                                                ...
                                                id="compare-mode"
                                            />
                                            <Label htmlFor="compare-mode">{translations?.compare || 'Compare'}</Label>
                                        </div>
                                    )}
                                ...
                                {isSmallScreen && (
                                    <Select defaultValue={selectedPreset} onValueChange={(value) => { setPreset(value) }}>
                                        <SelectTrigger className="w-[180px] mx-auto mb-2">
                                            <SelectValue placeholder={translations?.selectPreset || 'Select...'} />
                                        </SelectTrigger>
                                        <SelectContent>
                                            {PRESETS.map((preset) => (
