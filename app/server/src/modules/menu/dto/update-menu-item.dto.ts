...
export class UpdateMenuItemDto {
    @ApiPropertyOptional({ example: 'ITEM001', description: 'Item code' })
    @IsString()
    @IsOptional()
    @MaxLength(50)
    itemCode?: string;

    @ApiPropertyOptional({ example: 'Beef Steak', description: 'Item name' })
    @IsString()
    @IsOptional()
    @MaxLength(200)
    itemName?: string;
    ...
    @ApiPropertyOptional({ example: 150000, description: 'Item price' })
    @IsNumber()
    @IsOptional()
    @Min(0)
    price?: number;
