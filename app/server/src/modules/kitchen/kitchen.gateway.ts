...
import { KitchenOrder } from '@prisma/client';
    ...
    implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
    ...
    emitNewOrder(order: any) {
        ...
        this.logger.log(`Emitted new order: Kitchen Order #${order.id}`);
    }
    ...
    emitOrderUpdate(order: Partial<KitchenOrder>) {
        ...
        this.logger.log(
            `Emitted order update: Kitchen Order #${order.id} -> ${order.status}`,
        );
    }
    ...
    emitOrderCompleted(order: Partial<KitchenOrder>) {
        ...
        this.logger.log(`Emitted order completed: Kitchen Order #${order.id}`);
    }
}
